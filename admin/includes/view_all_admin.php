                    ...
                    <table class="filter">
                       ...
                       <tbody>
                           <?php
                            ...
                            $query ="SELECT * FROM users WHERE per_role = 'admin'";
                        ...
                        <tr>
                            ...
                            <td data-title="Price"><?php echo $row['username']?></td>
                            <td data-title="company"><?php echo $row['per_email']?></td>
                            <td data-title="image"><img src="images/<?php echo $row['per_img']?>" ></td>
                            <td data-title="category"><?php echo $row['per_phone']?></td>
                            <td data-title="Date"><?php echo $row['address']?></td>
                            <td data-title="Date"><?php echo $row['per_role']?></td>
