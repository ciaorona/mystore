                ...
                <div class="contener">
                    <div class="row">
                        <div class="counter1 counter">
                            ...
                            <p title="view more"><a href="">Laptops<i class="fas fa-arrow-circle-right"></i></a></p>
                            <?php
                        ...
                        <div class="counter2 counter">
                            ...
                            <a href="product.php"><p title="view more">Cameras <i class="fas fa-arrow-circle-right"></i></p></a>
                            <?php
                        ...
                        <div class="counter3 counter">
                            ...
                            <a href="product.php"><p title="view more">Phones <i class="fas fa-arrow-circle-right"></i></p></a>
                            <?php
                        ...
                        <div class="counter4 counter">
                            ...
                            <a href="product.php"><p title="view more">Accessories <i class="fas fa-arrow-circle-right"></i></p></a>
                            <?php
