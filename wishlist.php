<?php include "includes/header.php"; ?>
       ...
       if(isset($_SESSION['name'])){
        ?>
        <div class="wishList">
            <h1>YOUr Wish list (<?php $count =$connection->prepare("SELECT * FROM wishlist WHERE username=?" );
            ...
            <div class="contener">
                ...
                <?php
                    ...
                    $query=" SELECT p.product_name,p.product_img,p.product_price,w.product_id FROM products P INNER JOIN wishlist w ON P.product_id=w.product_id WHERE w.username=?";
